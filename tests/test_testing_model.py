...
def test_testing_model_accepts_a_card_list_when_instantiated_and_returns_elements_of_it_iteratively () :
    ...
    play_input = butilib.PlayInput(
        history=butilib.History(bazas=[]), card_set=card_set, cards=[], butifarra=True,
        contrada=butilib.NORMAL, player_c=0, player_number=1, delegated=False, game_variant=butilib.LIBRE
    )
