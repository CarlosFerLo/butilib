...
def test_model_has_cantar_method_that_expects_a_cantar_input_and_returns_a_cantar_output():
    ...
    cantar_input = butilib.CantarInput(
        cards=butilib.CardSet(cards=deck.pop_some(12)), delegated=False
    )
...
def test_model_cantar_method_raises_value_error_if_implementation_of_cantar_returns_delegate_in_delegated_call():
    ...
    deck = butilib.Deck.new()
    cantar_input = butilib.CantarInput(
        cards=butilib.CardSet(cards=deck.pop_some(12)), delegated=True
    )
...
def test_model_has_play_method_that_expects_play_input_and_returns_play_output_calling_auxiliar_call_function():
    class MyModel(butilib.Model):
        def _play(self, input: butilib.PlayInput) -> butilib.PlayOutput:
            return butilib.PlayOutput(card=input.card_set.cards[0])
...
def test_model_play_method_may_call_call_libre_or_call_obligada_if_defined():
    class MyModel(butilib.Model):
        ...
        def _play_libre(self, input: butilib.PlayInput) -> butilib.PlayOutput:
            return butilib.PlayOutput(card=input.card_set.cards[1])

        def _play_obligada(self, input: butilib.PlayInput) -> butilib.PlayOutput:
            return butilib.PlayOutput(card=input.card_set.cards[2])
...
def test_model_play_method_returns_forced_true_in_output_if_there_is_only_one_possible_card_to_play_if_you_have_just_one_card_of_the_forced_suit():
    ...
    play_input = butilib.PlayInput(
        ...
        butifarra=True,
        player_number=0,
        cards=[butilib.Card(number=4, suit=butilib.COPAS)],
        card_set=card_set,
        contrada=butilib.NORMAL,
        player_c=0,
        delegated=False,
    ...
    assert output == butilib.PlayOutput(
        card=butilib.Card(number=2, suit=butilib.COPAS), forced=True
    )
    ...
    assert output == butilib.PlayOutput(
        card=butilib.Card(number=7, suit=butilib.COPAS), forced=True
    )
...
def test_model_play_method_returns_forced_true_if_there_is_only_one_possible_card_to_play_you_have_more_than_one_of_f_suit_but_only_one_is_higher_and_the_enemy_team_is_winning():
    ...
    play_input = butilib.PlayInput(
        ...
        butifarra=True,
        player_number=0,
        cards=[butilib.Card(number=12, suit=butilib.BASTOS)],
        card_set=card_set,
        contrada=butilib.NORMAL,
        player_c=0,
        delegated=False,
    ...
    assert output == butilib.PlayOutput(
        card=butilib.Card(number=1, suit=butilib.BASTOS), forced=True
    )
    ...
    play_input = butilib.PlayInput(
        ...
        butifarra=True,
        player_number=0,
        cards=[butilib.Card(number=8, suit=butilib.BASTOS)],
        card_set=card_set,
        contrada=butilib.NORMAL,
        player_c=0,
        delegated=False,
...
def test_model_play_method_does_play_forced_when_is_not_winning_in_obligada_and_plays_the_lowest_number():
    ...
    play_input = butilib.PlayInput(
        history=butilib.History(
            bazas=[
                butilib.Baza(
                    initial_player=2,
                    cards=[
                        butilib.Card(number=i, suit=butilib.COPAS) for i in [9, 3, 2, 4]
                    ],
                )
            ]
        ),
        ...
        player_number=0,
        cards=[
            butilib.Card(number=8, suit=butilib.BASTOS),
    ...
    assert output == butilib.PlayOutput(
        card=butilib.Card(number=4, suit=butilib.BASTOS), forced=True
    )
...
def test_model_play_method_returns_forced_true_and_the_triumph_card_if_you_have_no_cards_of_the_forced_suit_and_only_one_of_triumph():
    ...
    play_input = butilib.PlayInput(
        ...
        cards=[
            butilib.Card(number=5, suit=butilib.COPAS),
            butilib.Card(number=10, suit=butilib.COPAS),
        ],
        card_set=card_set,
        contrada=butilib.NORMAL,
        player_c=1,
    ...
    assert output == butilib.PlayOutput(
        card=butilib.Card(number=1, suit=butilib.OROS), forced=True
    )
...
def test_model_play_method_returns_forced_true_and_the_last_card_if_only_one_card_on_the_card_set():
    ...
    card_set = butilib.CardSet(cards=[butilib.Card(number=9, suit=butilib.OROS)])
    ...
    history = butilib.History(
        bazas=[
            butilib.Baza(
                initial_player=0,
                cards=[
                    butilib.Card(number=i, suit=butilib.COPAS) for i in [9, 1, 12, 11]
                ],
            ),
            butilib.Baza(
                initial_player=0,
                cards=[
                    butilib.Card(number=i, suit=butilib.BASTOS) for i in [9, 1, 12, 11]
                ],
            ),
            butilib.Baza(
                initial_player=0,
                cards=[
                    butilib.Card(number=i, suit=butilib.ESPADAS) for i in [9, 1, 12, 11]
                ],
            ),
            butilib.Baza(
                initial_player=0,
                cards=[
                    butilib.Card(number=i, suit=butilib.COPAS) for i in [10, 8, 7, 6]
                ],
            ),
            butilib.Baza(
                initial_player=0,
                cards=[
                    butilib.Card(number=i, suit=butilib.OROS) for i in [10, 8, 7, 6]
                ],
            ),
            butilib.Baza(
                initial_player=0,
                cards=[
                    butilib.Card(number=i, suit=butilib.BASTOS) for i in [10, 8, 7, 6]
                ],
            ),
            butilib.Baza(
                initial_player=0,
                cards=[
                    butilib.Card(number=i, suit=butilib.ESPADAS) for i in [10, 8, 7, 6]
                ],
            ),
            butilib.Baza(
                initial_player=0,
                cards=[
                    butilib.Card(number=i, suit=butilib.COPAS) for i in [5, 4, 3, 2]
                ],
            ),
            butilib.Baza(
                initial_player=0,
                cards=[
                    butilib.Card(number=i, suit=butilib.BASTOS) for i in [5, 4, 3, 2]
                ],
            ),
            butilib.Baza(
                initial_player=0,
                cards=[
                    butilib.Card(number=i, suit=butilib.ESPADAS) for i in [5, 4, 3, 2]
                ],
            ),
            butilib.Baza(
                initial_player=0,
                cards=[butilib.Card(number=i, suit=butilib.OROS) for i in [5, 4, 3, 2]],
            ),
        ]
    )
    ...
    assert output == butilib.PlayOutput(
        card=butilib.Card(number=9, suit=butilib.OROS), forced=True
    )
...
def test_model_play_method_checks_returned_card_is_viable_else_raise_an_error():
    ...
    assert output == butilib.PlayOutput(
        card=butilib.Card(number=7, suit=butilib.BASTOS)
    )
